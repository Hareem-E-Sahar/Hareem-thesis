...
Similarly, SDP models frequently rely on machine learning (ML) and deep learning (DL) methods that are non-transparent~\cite{dam2018explainable,grattan2024need} in their decision-making, and produce outputs that are not actionable or informative enough to aid in fixing the defect. Furthermore, such models are difficult to update, and costly~\cite{shen2024efficient} to deploy at scale. This also makes their adoption less likely in practice~\cite{grattan2024need}. 
