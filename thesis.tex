...
\title{Facilitating the practical adoption of Software Defect Prediction through better techniques and empirical evaluation} % Title can't use formulae, symbols, superscripts, subscripts, greek letters, etc. all of which should be replaced with word substitutes
\author{Hareem Sahar}
